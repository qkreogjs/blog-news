...
const SITE_DESC = process.env.NEXT_PUBLIC_SITE_DESC ?? "최신 정보를 빠르게 전달합니다.";

export default function Home() {
  const recentPosts = getAllPosts("ko").slice(0, 3);
  ...
  return (
    <div>
      ...
      <section className="mb-12 py-8 border-b border-gray-100">
        ...
        <a
          href="/blog"
          className="inline-flex items-center gap-2 bg-blue-600 text-white text-sm px-5 py-2.5 rounded-full hover:bg-blue-700 transition-colors font-medium"
        >
          전체 글 보기 →
        </a>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          ...
          <a href="/blog" className="text-sm text-blue-500 hover:text-blue-700">더보기 →</a>
        </div>
